...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem, Logged {
    ...
    public void periodic() {
        ...
        log("Mod0/Velocity", this.getModule(0).getDriveMotor().getVelocity().getValueAsDouble());
        log("Mod0/Applied Voltage", this.getModule(0).getDriveMotor().getMotorVoltage().getValueAsDouble());
        log("Mod0/Supply Voltage", this.getModule(0).getDriveMotor().getSupplyVoltage().getValueAsDouble());
        log("Mod0/Temperature", this.getModule(0).getDriveMotor().getDeviceTemp().getValueAsDouble());

        log("Mod1/Supply Current", this.getModule(1).getDriveMotor().getSupplyCurrent().getValueAsDouble());
        log("Mod1/Stator Current", this.getModule(1).getDriveMotor().getStatorCurrent().getValueAsDouble());
        log("Mod1/Velocity", this.getModule(1).getDriveMotor().getVelocity().getValueAsDouble());
        log("Mod1/Applied Voltage", this.getModule(1).getDriveMotor().getMotorVoltage().getValueAsDouble());
        log("Mod1/Supply Voltage", this.getModule(1).getDriveMotor().getSupplyVoltage().getValueAsDouble());
        log("Mod1/Temperature", this.getModule(1).getDriveMotor().getDeviceTemp().getValueAsDouble());

        log("Mod2/Supply Current", this.getModule(2).getDriveMotor().getSupplyCurrent().getValueAsDouble());
        log("Mod2/Stator Current", this.getModule(2).getDriveMotor().getStatorCurrent().getValueAsDouble());
        log("Mod2/Velocity", this.getModule(2).getDriveMotor().getVelocity().getValueAsDouble());
        log("Mod2/Applied Voltage", this.getModule(2).getDriveMotor().getMotorVoltage().getValueAsDouble());
        log("Mod2/Supply Voltage", this.getModule(2).getDriveMotor().getSupplyVoltage().getValueAsDouble());
        log("Mod2/Temperature", this.getModule(2).getDriveMotor().getDeviceTemp().getValueAsDouble());

        log("Mod3/Supply Current", this.getModule(3).getDriveMotor().getSupplyCurrent().getValueAsDouble());
        log("Mod3/Stator Current", this.getModule(3).getDriveMotor().getStatorCurrent().getValueAsDouble());
        log("Mod3/Velocity", this.getModule(3).getDriveMotor().getVelocity().getValueAsDouble());
        log("Mod3/Applied Voltage", this.getModule(3).getDriveMotor().getMotorVoltage().getValueAsDouble());
        log("Mod3/Supply Voltage", this.getModule(3).getDriveMotor().getSupplyVoltage().getValueAsDouble());
        log("Mod3/Temperature", this.getModule(3).getDriveMotor().getDeviceTemp().getValueAsDouble());
    }
